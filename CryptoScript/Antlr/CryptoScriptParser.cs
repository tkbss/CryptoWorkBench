...
public partial class CryptoScriptParser : Parser {
	...
	public const int
		...
		M_DUKPT_TDEA_INITIAL_KEY=68, M_KDF_EP2_SESSION=69, M_KDF_EP2_PAN_SURROGATE_TRX=70,
		M_KDF_EP2_PAN_RECEIPT_TRX=71, M_KDF_EP2_PAN_RECEIPT_TRM=72, PADDING=73,
		PAD_ISO7816=74, PAD_PKCS7=75, PAD_ISO9797M1=76, PAD_ISO9797M2=77, PAD_ISO9797M3=78,
		PAD_ANSI_X923=79, PAD_TLS_CBC=80, PAD_NONE=81, PARAM_TYPE=82, P_MECHANISM=83,
		P_IV=84, P_PADDING=85, P_MAC_LENGTH=86, P_NONCE=87, P_COUNTER=88, P_ADATA=89,
		P_BLKHDR=90, P_RND=91, P_HASH=92, P_SALT=93, P_OUT_LENGTH=94, P_VARIANT=95,
		P_PRF=96, P_LABEL=97, P_USAGE=98, P_KEY_TYPE=99, WS=100, TR31_FIELD_NAME=101,
		TR31_FIELD_VALUE=102, TR31_KB_VERSION_ID=103, TR31_KB_LENGTH=104, TR31_WRAPPED_KEYLEN=105,
		TR31_KU=106, TR31_ALGO=107, TR31_MODEU=108, TR31_KEY_VERSION_NUM=109,
	...
	private static readonly string[] _LiteralNames = {
		...
		"'DUKPT-TDEA-INITIAL-KEY'", "'KDF-EP2-SESSION'", "'KDF-EP2-PAN-SURROGATE-TRX'",
	...
	private static readonly string[] _SymbolicNames = {
		...
		"M_DUKPT_TDEA_INITIAL_KEY", "M_KDF_EP2_SESSION", "M_KDF_EP2_PAN_SURROGATE_TRX",
	...
	private static int[] _serializedATN = {
		...
		5,24,0,0,63,64,5,82,0,0,64,65,5,2,0,0,65,85,5,73,0,0,66,67,5,82,0,0,67,
