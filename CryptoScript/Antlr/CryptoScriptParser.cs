...
public partial class CryptoScriptParser : Parser {
	...
	public const int
		...
		PAD_ISO7816=42, PAD_PKCS7=43, PAD_ISO9797M1=44, PAD_ISO9797M2=45, PAD_ISO9797M3=46, 
		PAD_ANSI_X923=47, PAD_NONE=48, PARAM_TYPE=49, P_MECHANISM=50, P_IV=51, 
		P_PADDING=52, P_NONCE=53, P_COUNTER=54, P_ADATA=55, P_BLKHDR=56, P_KEYBIND=57, 
		P_RND=58, WS=59, TR31_FIELD_NAME=60, TR31_FIELD_VALUE=61, TR31_KB_VERSION_ID=62, 
		TR31_KB_LENGTH=63, TR31_WRAPPED_KEYLEN=64, TR31_KU=65, TR31_ALGO=66, TR31_MODEU=67, 
		TR31_KEY_VERSION_NUM=68, TR31_EXPORTABILITY=69, TR31_NUM_OPT_BLOCKS=70, 
		TR31_KEY_CONTEXT=71, TR31_RESERVED_FIELD=72, TR31_OPT_BLOCK_ID=73, TR31_OPT_BLOCK_DATA=74, 
		NUM=75, KU_B0=76, KU_B1=77, KU_B2=78, KU_B3=79, KU_C0=80, KU_D0=81, KU_D1=82, 
		KU_D2=83, KU_D3=84, KU_E0=85, KU_E1=86, KU_E2=87, KU_E3=88, KU_F3=89, 
		KU_F4=90, KU_F5=91, KU_F6=92, KU_I0=93, KU_K0=94, KU_K1=95, KU_K2=96, 
		KU_K3=97, KU_K4=98, KU_M0=99, KU_M1=100, KU_P2=101, KU_V0=102, KU_V1=103, 
		KU_V2=104, KU_V3=105, KU_V4=106, KU_V5=107, KV_00=108, OPT_AL=109, OPT_BI=110, 
		OPT_CT=111, OPT_DA=112, OPT_HM=113, OPT_IK=114, OPT_KC=115, OPT_KP=116, 
		OPT_KS=117, OPT_KV=118, OPT_LB=119, OPT_PA=120, OPT_PB=121, OPT_PK=122, 
		OPT_TC=123, OPT_TS=124, OPT_WP=125, H=126, R=127, S=128, T=129, D=130, 
		E=131, A=132, B=133, C=134, G=135, N=136, V=137, X=138, Y=139;
	public const int
	...
	private static readonly string[] _LiteralNames = {
		...
		"'BIND-XOR'", "'BIND-CMAC'", null, "'ISO-7816'", "'PKCS-7'", "'ISO-9797-M1'", 
		"'ISO-9797-M2'", "'ISO-9797-M3'", "'ANSI-X923'", "'NONE'", null, "'#MECH'", 
		"'#IV'", "'#PAD'", "'#NONCE'", "'#COUNTER'", "'#ADATA'", "'#BLKH'", "'#BIND'", 
		"'#RND'", null, null, null, "'KBVID'", "'KBLEN'", "'WKL'", "'KEYU'", "'ALGO'", 
		"'MODEU'", "'KEYVN'", "'EXP'", "'NUMOPTB'", "'KEYCTX'", "'RSV'", "'OPTID'", 
		"'OPTBD'", null, "'B0'", "'B1'", "'B2'", "'B3'", "'C0'", "'D0'", "'D1'", 
		"'D2'", "'D3'", "'E0'", "'E1'", "'E2'", "'E3'", "'F3'", "'F4'", "'F5'", 
		"'F6'", "'I0'", "'K0'", "'K1'", "'K2'", "'K3'", "'K4'", "'M0'", "'M1'", 
		"'P2'", "'V0'", "'V1'", "'V2'", "'V3'", "'V4'", "'V5'", "'00'", "'AL'", 
		"'BI'", "'CT'", "'DA'", "'HM'", "'IK'", "'KC'", "'KP'", "'KS'", "'KV'", 
		"'LB'", "'PA'", "'PB'", "'PK'", "'TC'", "'TS'", "'WP'", "'H'", "'R'", 
		"'S'", "'T'", "'D'", "'E'", "'A'", "'B'", "'C'", "'G'", "'N'", "'V'", 
		"'X'", "'Y'"
	};
	private static readonly string[] _SymbolicNames = {
		...
		"M_BIND_CMAC", "PADDING", "PAD_ISO7816", "PAD_PKCS7", "PAD_ISO9797M1", 
		"PAD_ISO9797M2", "PAD_ISO9797M3", "PAD_ANSI_X923", "PAD_NONE", "PARAM_TYPE", 
		"P_MECHANISM", "P_IV", "P_PADDING", "P_NONCE", "P_COUNTER", "P_ADATA", 
		"P_BLKHDR", "P_KEYBIND", "P_RND", "WS", "TR31_FIELD_NAME", "TR31_FIELD_VALUE", 
	...
	public FunctionCallContext functionCall() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 562949970166272L) != 0)) {
				{
				State = 96;
				arguments();
				}
	...
	private static int[] _serializedATN = {
		4,1,139,118,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,
		...
		12,14,16,18,20,0,3,1,0,10,14,2,0,9,9,61,61,3,0,9,9,15,15,19,22,124,0,25,
		...
		49,0,0,61,62,5,2,0,0,62,76,5,23,0,0,63,64,5,49,0,0,64,65,5,2,0,0,65,76,
		5,41,0,0,66,67,5,49,0,0,67,68,5,2,0,0,68,76,5,19,0,0,69,70,5,49,0,0,70,
		71,5,2,0,0,71,76,5,18,0,0,72,73,5,49,0,0,73,74,5,2,0,0,74,76,5,21,0,0,
		...
		86,5,4,0,0,86,11,1,0,0,0,87,88,5,60,0,0,88,89,5,2,0,0,89,90,7,1,0,0,90,
