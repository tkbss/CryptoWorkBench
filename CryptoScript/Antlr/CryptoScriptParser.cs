...
public partial class CryptoScriptParser : Parser {
	...
	public const int
		...
		M_HMAC_SHA3_384=40, M_HMAC_SHA3_512=41, M_DES3_ECB=42, M_DES3_CBC=43, 
		M_DES3_RETAIL=44, M_DES3_CMAC=45, M_WRAP_AES_TR31=46, M_WRAP_DES3_TR31=47, 
		M_WRAP_AES=48, M_WRAP_DES3=49, PADDING=50, PAD_ISO7816=51, PAD_PKCS7=52, 
		PAD_ISO9797M1=53, PAD_ISO9797M2=54, PAD_ISO9797M3=55, PAD_ANSI_X923=56, 
		PAD_TLS_CBC=57, PAD_NONE=58, PARAM_TYPE=59, P_MECHANISM=60, P_IV=61, P_PADDING=62, 
		P_MAC_LENGTH=63, P_NONCE=64, P_COUNTER=65, P_ADATA=66, P_BLKHDR=67, P_RND=68, 
		WS=69, TR31_FIELD_NAME=70, TR31_FIELD_VALUE=71, TR31_KB_VERSION_ID=72, 
		TR31_KB_LENGTH=73, TR31_WRAPPED_KEYLEN=74, TR31_KU=75, TR31_ALGO=76, TR31_MODEU=77, 
		TR31_KEY_VERSION_NUM=78, TR31_EXPORTABILITY=79, TR31_NUM_OPT_BLOCKS=80, 
		TR31_KEY_CONTEXT=81, TR31_RESERVED_FIELD=82, TR31_OPT_BLOCK_ID=83, TR31_OPT_BLOCK_DATA=84, 
		NUM=85, KU_B0=86, KU_B1=87, KU_B2=88, KU_B3=89, KU_C0=90, KU_D0=91, KU_D1=92, 
		KU_D2=93, KU_D3=94, KU_E0=95, KU_E1=96, KU_E2=97, KU_E3=98, KU_F3=99, 
		KU_F4=100, KU_F5=101, KU_F6=102, KU_I0=103, KU_K0=104, KU_K1=105, KU_K2=106, 
		KU_K3=107, KU_K4=108, KU_M0=109, KU_M1=110, KU_P2=111, KU_V0=112, KU_V1=113, 
		KU_V2=114, KU_V3=115, KU_V4=116, KU_V5=117, KV_00=118, OPT_AL=119, OPT_BI=120, 
		OPT_CT=121, OPT_DA=122, OPT_HM=123, OPT_IK=124, OPT_KC=125, OPT_KP=126, 
		OPT_KS=127, OPT_KV=128, OPT_LB=129, OPT_PA=130, OPT_PB=131, OPT_PK=132, 
		OPT_TC=133, OPT_TS=134, OPT_WP=135, H=136, R=137, S=138, T=139, D=140, 
		E=141, A=142, B=143, C=144, G=145, N=146, V=147, X=148, Y=149;
	public const int
	...
	private static readonly string[] _LiteralNames = {
		...
		"'HMAC-SHA3-512'", "'DES3-ECB'", "'DES3-CBC'", "'DES3-RETAIL'", "'DES3-CMAC'", 
		"'WRAP-AES-TR31'", "'WRAP-DES3-TR31'", "'WRAP-AES'", "'WRAP-DES3'", null, 
		"'ISO-7816'", "'PKCS-7'", "'ISO-9797-M1'", "'ISO-9797-M2'", "'ISO-9797-M3'", 
	...
	public FunctionCallContext functionCall() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 576460752320168448L) != 0)) {
				{
				State = 96;
				arguments();
				}
	...
	private static int[] _serializedATN = {
		4,1,149,118,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,
		...
		12,14,16,18,20,0,3,1,0,10,14,2,0,9,9,71,71,3,0,9,9,15,15,19,22,124,0,25,
		...
		59,0,0,61,62,5,2,0,0,62,76,5,23,0,0,63,64,5,59,0,0,64,65,5,2,0,0,65,76,
		5,50,0,0,66,67,5,59,0,0,67,68,5,2,0,0,68,76,5,19,0,0,69,70,5,59,0,0,70,
		71,5,2,0,0,71,76,5,18,0,0,72,73,5,59,0,0,73,74,5,2,0,0,74,76,5,21,0,0,
		...
		86,5,4,0,0,86,11,1,0,0,0,87,88,5,70,0,0,88,89,5,2,0,0,89,90,7,1,0,0,90,
