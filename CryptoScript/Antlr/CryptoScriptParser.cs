...
public partial class CryptoScriptParser : Parser {
	...
	public const int
		...
		M_WRAP_AES=37, M_WRAP_DES3=38, PADDING=39, PAD_ISO7816=40, PAD_PKCS7=41,
		PAD_ISO9797M1=42, PAD_ISO9797M2=43, PAD_ISO9797M3=44, PAD_ANSI_X923=45,
		PAD_TLS_CBC=46, PAD_NONE=47, PARAM_TYPE=48, P_MECHANISM=49, P_IV=50, P_PADDING=51,
		P_MAC_LENGTH=52, P_NONCE=53, P_COUNTER=54, P_ADATA=55, P_BLKHDR=56, P_RND=57,
		WS=58, TR31_FIELD_NAME=59, TR31_FIELD_VALUE=60, TR31_KB_VERSION_ID=61,
		TR31_KB_LENGTH=62, TR31_WRAPPED_KEYLEN=63, TR31_KU=64, TR31_ALGO=65, TR31_MODEU=66,
		TR31_KEY_VERSION_NUM=67, TR31_EXPORTABILITY=68, TR31_NUM_OPT_BLOCKS=69,
		TR31_KEY_CONTEXT=70, TR31_RESERVED_FIELD=71, TR31_OPT_BLOCK_ID=72, TR31_OPT_BLOCK_DATA=73,
		NUM=74, KU_B0=75, KU_B1=76, KU_B2=77, KU_B3=78, KU_C0=79, KU_D0=80, KU_D1=81,
		KU_D2=82, KU_D3=83, KU_E0=84, KU_E1=85, KU_E2=86, KU_E3=87, KU_F3=88,
		KU_F4=89, KU_F5=90, KU_F6=91, KU_I0=92, KU_K0=93, KU_K1=94, KU_K2=95,
		KU_K3=96, KU_K4=97, KU_M0=98, KU_M1=99, KU_P2=100, KU_V0=101, KU_V1=102,
		KU_V2=103, KU_V3=104, KU_V4=105, KU_V5=106, KV_00=107, OPT_AL=108, OPT_BI=109,
		OPT_CT=110, OPT_DA=111, OPT_HM=112, OPT_IK=113, OPT_KC=114, OPT_KP=115,
		OPT_KS=116, OPT_KV=117, OPT_LB=118, OPT_PA=119, OPT_PB=120, OPT_PK=121,
		OPT_TC=122, OPT_TS=123, OPT_WP=124, H=125, R=126, S=127, T=128, D=129,
		E=130, A=131, B=132, C=133, G=134, N=135, V=136, X=137, Y=138;
	public const int
	...
	public FunctionCallContext functionCall() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 281474993455616L) != 0)) {
				{
				State = 96;
				arguments();
				}
	...
	private static int[] _serializedATN = {
		4,1,138,118,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,
		...
		12,14,16,18,20,0,3,1,0,10,14,2,0,9,9,60,60,3,0,9,9,15,15,19,22,124,0,25,
		...
		48,0,0,61,62,5,2,0,0,62,76,5,23,0,0,63,64,5,48,0,0,64,65,5,2,0,0,65,76,
		5,39,0,0,66,67,5,48,0,0,67,68,5,2,0,0,68,76,5,19,0,0,69,70,5,48,0,0,70,
		71,5,2,0,0,71,76,5,18,0,0,72,73,5,48,0,0,73,74,5,2,0,0,74,76,5,21,0,0,
		...
		86,5,4,0,0,86,11,1,0,0,0,87,88,5,59,0,0,88,89,5,2,0,0,89,90,7,1,0,0,90,
