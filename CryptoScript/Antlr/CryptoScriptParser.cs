...
public partial class CryptoScriptParser : Parser {
	...
	public const int
		...
		PAD_ANSI_X923=47, PAD_TLS_CBC=48, PAD_NONE=49, PARAM_TYPE=50, P_MECHANISM=51, 
		P_IV=52, P_PADDING=53, P_NONCE=54, P_COUNTER=55, P_ADATA=56, P_BLKHDR=57, 
		P_KEYBIND=58, P_RND=59, WS=60, TR31_FIELD_NAME=61, TR31_FIELD_VALUE=62, 
		TR31_KB_VERSION_ID=63, TR31_KB_LENGTH=64, TR31_WRAPPED_KEYLEN=65, TR31_KU=66, 
		TR31_ALGO=67, TR31_MODEU=68, TR31_KEY_VERSION_NUM=69, TR31_EXPORTABILITY=70, 
		TR31_NUM_OPT_BLOCKS=71, TR31_KEY_CONTEXT=72, TR31_RESERVED_FIELD=73, TR31_OPT_BLOCK_ID=74, 
		TR31_OPT_BLOCK_DATA=75, NUM=76, KU_B0=77, KU_B1=78, KU_B2=79, KU_B3=80, 
		KU_C0=81, KU_D0=82, KU_D1=83, KU_D2=84, KU_D3=85, KU_E0=86, KU_E1=87, 
		KU_E2=88, KU_E3=89, KU_F3=90, KU_F4=91, KU_F5=92, KU_F6=93, KU_I0=94, 
		KU_K0=95, KU_K1=96, KU_K2=97, KU_K3=98, KU_K4=99, KU_M0=100, KU_M1=101, 
		KU_P2=102, KU_V0=103, KU_V1=104, KU_V2=105, KU_V3=106, KU_V4=107, KU_V5=108, 
		KV_00=109, OPT_AL=110, OPT_BI=111, OPT_CT=112, OPT_DA=113, OPT_HM=114, 
		OPT_IK=115, OPT_KC=116, OPT_KP=117, OPT_KS=118, OPT_KV=119, OPT_LB=120, 
		OPT_PA=121, OPT_PB=122, OPT_PK=123, OPT_TC=124, OPT_TS=125, OPT_WP=126, 
		H=127, R=128, S=129, T=130, D=131, E=132, A=133, B=134, C=135, G=136, 
		N=137, V=138, X=139, Y=140;
	public const int
	...
	private static readonly string[] _LiteralNames = {
		...
		"'#BLKH'", "'#BIND'", "'#RND'", null, null, null, "'KBVID'", "'KBLEN'", 
	...
	private static readonly string[] _SymbolicNames = {
		...
		"PARAM_TYPE", "P_MECHANISM", "P_IV", "P_PADDING", "P_NONCE", "P_COUNTER", 
		"P_ADATA", "P_BLKHDR", "P_KEYBIND", "P_RND", "WS", "TR31_FIELD_NAME", 
	...
	public FunctionCallContext functionCall() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1125899923587584L) != 0)) {
				{
				State = 96;
				arguments();
				}
	...
	private static int[] _serializedATN = {
		4,1,140,118,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,
		...
		12,14,16,18,20,0,3,1,0,10,14,2,0,9,9,62,62,3,0,9,9,15,15,19,22,124,0,25,
		...
		50,0,0,61,62,5,2,0,0,62,76,5,23,0,0,63,64,5,50,0,0,64,65,5,2,0,0,65,76,
		5,41,0,0,66,67,5,50,0,0,67,68,5,2,0,0,68,76,5,19,0,0,69,70,5,50,0,0,70,
		71,5,2,0,0,71,76,5,18,0,0,72,73,5,50,0,0,73,74,5,2,0,0,74,76,5,21,0,0,
		...
		86,5,4,0,0,86,11,1,0,0,0,87,88,5,61,0,0,88,89,5,2,0,0,89,90,7,1,0,0,90,
