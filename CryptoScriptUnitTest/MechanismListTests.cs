...
public class MechanismListTests
{
    ...
    private static readonly string[] Expected =
    {
        ...
        "HKDF-EXTRACT", "HKDF-EXPAND", "KDF-SP800-108-COUNTER", "DUKPT-AES-INITIAL-KEY", "DUKPT-AES-WORKING-KEY", "DUKPT-TDEA-INITIAL-KEY", "KDF-EP2-SESSION",
    ...
    [Test]
    public void ContainsTdeaDukptInitialKeyExactlyOnce()
    {
        Assert.That(MechanismList.Instance.Mechanisms.Count(
            mechanism => mechanism == "DUKPT-TDEA-INITIAL-KEY"), Is.EqualTo(1));
    }
